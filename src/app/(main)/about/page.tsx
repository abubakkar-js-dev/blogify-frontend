      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
        ...
        >
          ...
          <p className="text-lg text-slate-600 leading-relaxed mb-8">
            ...
            is it so hard to start a beautiful blog without being a tech expert?
          </p>
          <p className="text-lg text-slate-600 leading-relaxed">
            Today, we&apos;re a global team empowering thousands of writers to share
            their passions, build their brands, and connect with audiences they
