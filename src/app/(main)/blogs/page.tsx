  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        setCategoryList([{ name: 'All', icon: '', color: '', count: '' } as BlogCategory, ...fetchedCategories]);
      } catch (error) {
      ...
      <div className="mb-12">
        ...
        >
          <div>
            ...
            <p className="text-slate-500">Discover stories, thinking, and expertise from writers everywhere.</p>
          </div>
          ...
          <motion.div key="results" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            {featuredPost && (
              <motion.div 
                ...
                className="group relative mb-20 aspect-[4/5] sm:aspect-[16/9] md:aspect-[21/9] rounded-[2.5rem] overflow-hidden cursor-pointer shadow-2xl shadow-slate-200"
              >
                <Image 
                ...
                <div className="absolute bottom-4 left-4 right-4 sm:bottom-8 sm:left-8 sm:right-8 md:bottom-12 md:left-12 md:right-12">
                  <div className="flex flex-wrap items-center gap-3 mb-4">
                    <span className={`${featuredPost.tagColor} px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider`}>
                      {selectedCategory === 'All' ? 'Featured: ' : ''}{featuredPost.tag}
                    </span>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 sm:gap-4">
                     <div className="flex items-center gap-3">
                        ...
                        <div className="text-white">
                          ...
                          <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">{featuredPost.date}</p>
                        </div>
                     </div>
                ...
                >
                  <Link href={`/blogs/${post.slug}`} className="relative aspect-[4/3] block overflow-hidden">
                    <Image 
                      ...
                      referrerPolicy="no-referrer"
                    />
                    <div className={`absolute bottom-4 left-4 ${post.tagColor} px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider shadow-sm`}>
                      {post.tag}
                    </div>
                  ...
                  <div className="p-8 flex flex-col flex-1">
                    ...
                    <Link href={`/blogs/${post.slug}`} className="block mb-4 group/title">
                      <h3 className="text-xl font-bold text-slate-900 leading-tight group-hover/title:text-teal-600 transition-colors line-clamp-2 min-h-[3rem]">
                        {post.title}
                      </h3>
                    </Link>
                    ...
                    <div className="flex items-center justify-between pt-6 border-t border-slate-50">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-xs">
                          ...
                          <p className="text-[10px] text-slate-400">Verified Writer</p>
                        </div>
                      </div>
