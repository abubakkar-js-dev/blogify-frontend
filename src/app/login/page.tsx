      ...
      <div className="flex items-center justify-center p-8 md:p-16 lg:p-24 bg-white relative">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button 
              disabled={isLoading}
              className="w-full py-4 bg-teal-600 text-white rounded-xl font-bold hover:bg-teal-700 transition-all flex items-center justify-center gap-2 transform active:scale-[0.98] shadow-xl shadow-teal-600/20 disabled:opacity-50"
            >
              {isLoading ? (
                <>
